              ...
              <div className="text-center py-12">
                ...
                <div className="mb-6">
                  ...
                  <div className="flex justify-center space-x-4">
                    <button 
                      onClick={() => window.open(`https://twitter.com/intent/tweet?text=Just%20found%20a%20great%20resource%20for%20RESP%20planning%20-%20The%20RESP%20Guy%20helps%20families%20secure%20their%20children's%20education%20future!&url=${window.location.href}`, '_blank')}
                    ...
                    <button 
                      ...
                      className="bg-blue-800 hover:bg-blue-900 text-white px-4 py-2 rounded-lg transition-colors duration-300 flex items-center"
                    >
                      <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
